...
/// Protótipo web completo (mesmo conteúdo do serve_web.py / TestFlight build 54+).
class WebAppScreen extends StatefulWidget {
  const WebAppScreen({super.key});

  static const buildLabel = 'Build 54 · Web App';
  ...
  Future<void> _start() async {
    try {
      ...
      try {
        ...
        await server.start();
        url = WebUri('http://127.0.0.1:${server.port}/index.html?v=54');
      } catch (_) {
        server?.close();
      ...
      return _shell(
        child: Padding(
          ...
          child: Text(
            ...
            '(repo idoso-care-24h). Apague o app e instale o build 54 do repo troca-copa-2026.',
